...
/*Metodo agregar*/
    public playlist AgregarPlaylist(String tituloPlaylist,String nombreArchivo){
        Conectar conec = new Conectar();
        String sql = "INSERT INTO playlist (tituloPlaylist,nombreArchivo) VALUES(?,?);";
        PreparedStatement ps = null;
        playlist playlist = null;
        try{
            ps = conec.getConnection().prepareStatement(sql);
            ps.setString(1, tituloPlaylist);
